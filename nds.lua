...
local Tabs = {
    ...
    Config = Window:AddTab({ Title = "Config", Icon = "folder-cog"}),
...
do
    ...
    Tabs.Main:AddButton({
        ...
        Description = "Show you the cureent disaster with notif",
        Callback = function()
            Fluent:Notify({
                Title = "Current Disaster",
...
InterfaceManager:SetFolder("L1r3")
SaveManager:SetFolder("L1r3/nds")
